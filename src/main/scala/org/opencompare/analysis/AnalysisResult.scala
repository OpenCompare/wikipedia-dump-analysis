...
case class PCMStats(id : String, title : String, filename : String, circularTest : List[CircularTestResult], features : Int, products : Int, featureDepth : Int, emptyCells : Int, valueResult : ValueResult) extends AnalysisResult
